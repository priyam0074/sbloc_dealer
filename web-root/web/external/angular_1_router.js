...
var componentModuleName = 'ngComponentRouter';
 ...
 */
function ngOutletDirective($animate, $q, $router, $timeout) {
    ...
    function outletLink(scope, element, attrs, ctrls, $transclude) {
        var Outlet = (function () {
            function Outlet(controller, router, $timeout) {
            ...
            Outlet.prototype.activate = function (instruction) {
                ...
                // by debug mode
                //putting timeout as per recommendation form angular1_router team.
                // Added 500 ms as simple timeout was not executing onActivate everytime.
                return $timeout(function(){
                    _this.currentController = _this.currentElement.children().eq(0).controller(componentName);
                    if (_this.currentController && _this.currentController.$routerOnActivate) {
                        return _this.currentController.$routerOnActivate(instruction, previousInstruction);
                    }
                    return $q.when();
                },500);
            };
        ...
        router.registerPrimaryOutlet(new Outlet(myCtrl, router, $timeout));
    }
}

ngOutletDirective.$inject = ['$animate', '$q', '$router', '$timeout'];
 ...
 * ```
 */
function ngLinkDirective($router, $parse, $timeout) {
    var rootRouter = $router;
    ...
    function ngLinkDirectiveLinkFn(scope, element, attrs, ctrl) {
        ...
        element.on('click', function (event) {
            ...
            scope.$root.$broadcast('Loader.Shown');
            $timeout(function(){
                scope.$root.$broadcast('Loader.Hide');
            },550);
...
ngLinkDirective.$inject = ['$router', '$parse', '$timeout'];
...
// TODO: https://github.com/angular/angular.js/blob/master/src/ng/browser.js#L227-L265
    ...
    var _require = function () {return _exports;};
    ...
    _exports.RouteLifecycleHook = RouteLifecycleHook;
    ...
    _exports.CanActivate = CanActivate;
    _exports.routerCanReuse = CONST_EXPR(new RouteLifecycleHook("routerCanReuse"));
    _exports.routerCanDeactivate = CONST_EXPR(new RouteLifecycleHook("routerCanDeactivate"));
    _exports.routerOnActivate = CONST_EXPR(new RouteLifecycleHook("routerOnActivate"));
    _exports.routerOnReuse = CONST_EXPR(new RouteLifecycleHook("routerOnReuse"));
    _exports.routerOnDeactivate = CONST_EXPR(new RouteLifecycleHook("routerOnDeactivate"));
    ...
    _exports.pathSegmentsToUrl = pathSegmentsToUrl;
    ...
    _exports.UrlParser = UrlParser;
    _exports.parser = new UrlParser();
    ...
    _exports.serializeParams = serializeParams;
    var __extends = (this && this.__extends) || function (d, b) {
            for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
            function __() { this.constructor = d; }
            d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
        };
    var instruction_1 = _require('./instruction');
    var path_recognizer_1 = _require('./path_recognizer');
    ...
    _exports.RedirectMatch = RedirectMatch;
    ...
    _exports.RedirectRecognizer = RedirectRecognizer;
// represents something like '/foo/:bar'
    ...
    var route_definition_1 = _require('./route_definition');
    _exports.RouteDefinition = route_definition_1.RouteDefinition;
    /**
    ...
    _exports.RouteConfig = RouteConfig;
    /**
 ...
 * 'MyLoadedCmp'})
    ...
    _exports.AsyncRoute = AsyncRoute;
    /**
    ...
    _exports.AsyncRouteHandler = AsyncRouteHandler;
    var instruction_1 = _require('./instruction');
    ...
    _exports.SyncRouteHandler = SyncRouteHandler;
    var route_recognizer_1 = _require('./route_recognizer');
    var route_config_impl_1 = _require('./route_config_impl');
    var async_route_handler_1 = _require('./async_route_handler');
    var sync_route_handler_1 = _require('./sync_route_handler');
    /**
    ...
    _exports.ComponentRecognizer = ComponentRecognizer;
    var __extends = (this && this.__extends) || function (d, b) {
            for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
            function __() { this.constructor = d; }
            d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
 ...
 * }
    ...
    _exports.RouteParams = RouteParams;
    /**
 ...
 * }
    ...
    _exports.BLANK_ROUTE_DATA = new RouteData();
    /**
 ...
 * }
    ...
    _exports.Instruction = Instruction;
    /**
    ...
    _exports.ResolvedInstruction = ResolvedInstruction;
    /**
    ...
    _exports.DefaultInstruction = DefaultInstruction;
    /**
    ...
    _exports.UnresolvedInstruction = UnresolvedInstruction;
    ...
    _exports.RedirectInstruction = RedirectInstruction;
    /**
    ...
    var ComponentInstruction = (function () {
        function ComponentInstruction(urlPath, urlParams, data, componentType, terminal, specificity, params) {
            ...
            this.params = params;
            this.reuse = false;
            this.routeData = isPresent(data) ? data : _exports.BLANK_ROUTE_DATA;
        }
        return ComponentInstruction;
    })();
    _exports.ComponentInstruction = ComponentInstruction;
    var url_parser_1 = _require('./url_parser');
...
// `/foo/:name`
    ...
    _exports.PathRecognizer = PathRecognizer;
    var route_config_decorator_1 = _require('./route_config_decorator');
    /**
    ...
    _exports.normalizeRouteConfig = normalizeRouteConfig;
    ...
    _exports.assertComponentExists = assertComponentExists;
    var lifecycle_annotations_impl_1 = _require('./lifecycle_annotations_impl');
    function hasLifecycleHook(e, type) {
        if (!(type instanceof Type))
            return false;
        return e.name in type.prototype;
    }
    _exports.hasLifecycleHook = hasLifecycleHook;
    ...
    _exports.getCanActivateHook = getCanActivateHook;
    var core_1 = _require('angular2/core');
    var route_config_impl_1 = _require('./route_config_impl');
    var route_recognizer_1 = _require('./route_recognizer');
    var component_recognizer_1 = _require('./component_recognizer');
    var instruction_1 = _require('./instruction');
    var route_config_nomalizer_1 = _require('./route_config_nomalizer');
    var url_parser_1 = _require('./url_parser');
 ...
 * }
     ...
     * ```
     */
    _exports.ROUTER_PRIMARY_COMPONENT = CONST_EXPR(new core_1.OpaqueToken('RouterPrimaryComponent'));
    /**
    ...
    _exports.RouteRegistry = RouteRegistry;
    /*
     * Given: ['/a/b', {c: 2}]
     * Returns: ['', 'a', 'b', {c: 2}]
     */
    ...
    var route_lifecycle_reflector_1 = _require('./route_lifecycle_reflector');
    ...
    _exports.RootRouter = RootRouter;
    ...
    _exports.getCanActivateHook = function (directiveName) {
    ...
    _exports.assertComponentExists = function () {};

    angular.stringifyInstruction = function (instruction) {
        return instruction.toRootUrl();
    };

    var RouteRegistry = _exports.RouteRegistry;
    var RootRouter = _exports.RootRouter;
...
routerFactory.$inject = ['$q', '$location', '$$directiveIntrospector', '$browser', '$rootScope', '$injector', '$routerRootComponent'];
module.exports = angular.module(componentModuleName);